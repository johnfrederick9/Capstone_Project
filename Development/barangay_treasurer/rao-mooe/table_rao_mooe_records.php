                    ...
                    <script type="text/javascript">
                       ...
                       // Function to format the period covered
                            ...
                            if (attribute_name.length > 0 && !attribute_name.includes("")) {
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        showAlert('Attributes added successfully!',"alert-danger");
                        ...
                        $(document).on('submit', '#updateAttributeForm', function (e) {
                            ...
                            if (!rao_mooe_id) {
                                showAlert('Error: RAO mooe ID is missing.',"alert-danger");
                                return;
                            }
                                    ...
                                    try {
                                        ...
                                        if (json.new_attributes && json.new_attributes.length > 0) {
                                          ...
                                          ///////////////////////////Remove////////////////////////
                                            ...
                                            showAlert("Attribute Added successfully.", "alert-success");
                                        } else {
                                            showAlert('Update failed: ' + (json.error || 'Unknown error'), "alert-danger");
                                        }
                                    } catch (error) {
