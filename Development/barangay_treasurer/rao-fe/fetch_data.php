...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    <div class="dropdown">
			...
			<div class="dropdown-menu">
				<a href="javascript:void(0);" data-id="' . $row['rao_fe_id'] . '" class="dropdown-item update-btn editbtn"><i class="bx bx-edit"></i></a>
				 <a href="javascript:void(0);" data-item-id="' . $row['rao_fe_id'] . '" class="dropdown-item view-btn infoBtn"><i class="bx bx-info-circle"></i></a>
                 <a href="javascript:void(0);" data-rao_id="' . $row['rao_fe_id'] . '" class="dropdown-item delete-btn deleteBtn"><i class="bx bx-trash"></i></a>
			</div>';
    $data[] = $sub_array;
}
