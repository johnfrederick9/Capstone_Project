...
$financial_filepath = basename($_FILES["financial_filepath"]["name"]);
...
$sql = "INSERT INTO `tb_financial` (`financial_type`,`financial_date`,`financial_filepath`) values ('$financial_type', '$financial_date', '$financial_filepath')";
