...
$sql = "SELECT * FROM tb_rao_co WHERE isDisplayed = 1"; 
$totalQuery = mysqli_query($con, $sql);
$total_all_rows = mysqli_num_rows($totalQuery);

// Modify query for filtering and searching
$sql = "SELECT * FROM tb_rao_co WHERE isDisplayed = 1"; // Reset base query for filtered data
    ...
    $sub_array[] = '
        <div class="dropdown">
			...
			<div class="dropdown-menu">
				                        <a href="javascript:void(0);" data-id="' . $row['rao_co_id'] . '" class="dropdown-item update-btn editbtn"><i class="bx bx-edit"></i></a>  
                        <a href="javascript:void(0);" data-rao_id="' . $row['rao_co_id'] . '" class="dropdown-item delete-btn deleteBtn"><i class="bx bx-trash"></i></a>
                        <a href="javascript:void(0);" data-item-id="' . $row['rao_co_id'] . '" class="dropdown-item view-btn infoBtn"><i class="bx bx-info-circle"></i></a>
			</div>';
    $data[] = $sub_array;
}
