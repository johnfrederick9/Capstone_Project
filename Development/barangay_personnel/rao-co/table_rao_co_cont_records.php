                    ...
                    <div class="head">
                        ...
                        <button class="dropdown-toggle">Other RAO Sources</button>
                            <ul class="dropdown-menu">
                                <li><a href="../../barangay_personnel/rao/table_rao_records.php">RAO-PS</a></li>
                                <li><a href="../../barangay_personnel/rao-cont/table_rao_cont_records.php">RAO-CONT</a></li>
                                <li><a href="../../barangay_personnel/rao-fe/table_rao_fe_records.php">RAO-FE</a></li>
                                <li><a href="../../barangay_personnel/rao-mooe/table_rao_mooe_records.php">RAO-MOOE</a></li>
                                <li><a href="../../barangay_personnel/rao-bdrrmf/table_rao_bdrrmf_records.php">RAO-BDRRMF</a></li>
                                <li><a href="../../barangay_personnel/rao-dev/table_rao_dev_records.php">RAO-DEV</a></li>
                                <li><a href="../../barangay_personnel/rao-sk/table_rao_sk_records.php">RAO-SK</a></li>
                                <li><a href="../../barangay_personnel/co-cont/table_rao_cocont_records.php">RAO-CO-CONT</a></li>
                            </ul>
                        </div>  
