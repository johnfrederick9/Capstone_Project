    ...
    if ($row = mysqli_fetch_assoc($query)) {
        ...
        <body>
            <div class="certificate-container">
                ...
                <div class="content">
                    <p>This is to certify that <strong style="text-transform: uppercase;">'.$row['indigency_cname'].'</strong><strong> a legal age,</strong> and a resident in Mantalongon, Dalaguete, Cebu.</p>
                    <p>This certifies further that the person mentioned above belongs to indigent families.</p>
                    <p>This certification is issued upon the <strong style="text-transform: uppercase;">'.$row['indigency_cname'].'</strong> to support his/her requirements for <strong>MEDICAL/FINANCIAL ASSISTANCE</strong>.</p>
