...
if (isset($_POST['id'])) {
    ...
    // Query to fetch residency details
    $sql = "SELECT * FROM tb_residency WHERE residency_id = $id";
    ...
    if ($row = mysqli_fetch_assoc($query)) {
        ...
        if ($captain_row) {
            $captain_name = strtoupper($captain_row['firstname'] . ' ' . $captain_row['middlename'] . ' ' . $captain_row['lastname']);
        ...
        // Format the date
        $originalDate = $row['residency_date'];
            ...
            <div class="certificate-container">
                <div class="header">
                    ...
                    <div class="header-content">
                        ...
                        <h2 style="margin-bottom: 0px; margin-top: 0;">B A R A N G A Y &nbsp; C E R T I F I C A T I O N</h2>
                ...
                <div class="content">
                    <p>This is to CERTIFY that <strong style="text-transform: uppercase;">'.$row['residency_name'].'</strong>, of legal age, single and a resident of Barangay Mantalongon, Dalaguete, Cebu. He/She is known as a person of good moral standing in the community and has no record inimical to the society pursuant to the files available in this office.</p>
                    <p>This certification is issued upon the request of the above mentioned name for <strong style="text-transform: uppercase;">'.$row['residency_issued'].'</strong>.</p>
                ...
                <div class="footer">
                    <div class="footer-box">
                        <div class="row">
                            ...
                            <div class="column">
                                <p><strong>₱'.$row['residency_paid'].'.00</strong></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="column">
                            ...
                            <div class="column">
                                <p><strong>₱'.$row['residency_dst'].'.00</strong></p>
                            </div>
                        </div>
                    </div>
                    <div>
