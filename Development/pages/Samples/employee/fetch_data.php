...
$sql = "SELECT * FROM tb_employee ";
	...
	3 => 'employee_lastname',
	4 => 'employee_maidenname',	
	5 => 'employee_address',	
	6 => 'employee_educationalattainment',	
...
while($row = mysqli_fetch_assoc($query))
{
	...
	$sub_array[] = '<div class= "buttons">
						<a href="javascript:void();" data-id="'.$row['employee_id'].'"  class="update-btn btn-sm editbtn" ><i class="bx bx-sync"></i></a>  
					</div>';
	$data[] = $sub_array;
}
