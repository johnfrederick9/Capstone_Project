...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    $sub_array[] = '<div class="buttons">
                        <a href="javascript:void(0);" data-id="' . $row['rao_cont_id'] . '" class="update-btn btn-sm editbtn"><i class="bx bx-sync"></i></a>  
                        <a href="javascript:void(0);" data-rao_id="' . $row['rao_cont_id'] . '" class="delete-btn btn-sm deleteBtn"><i class="bx bxs-trash"></i></a>
                        <a href="javascript:void(0);" data-item-id="' . $row['rao_cont_id'] . '" class="update-btn btn-sm infoBtn"><i class="bx bx-info-circle"></i></a>
                    </div>';
    $data[] = $sub_array;
}
