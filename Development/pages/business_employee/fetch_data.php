...
while ($row = mysqli_fetch_assoc($query)) 
{
    ...
    <div class="dropdown">
			...
			<div class="dropdown-menu">
                <a href="javascript:void(0);" data-id="' . $row['bemp_id'] . '" class="dropdown-item print-btn">
					 <i class="bx bx-printer"></i>
				</a>
				<a href="javascript:void(0);" data-id="' . $row['bemp_id'] . '" class="dropdown-item update-btn editbtn">
					<i class="bx bx-edit"></i>
				</a>
				<a href="javascript:void(0);" data-id="' . $row['bemp_id'] . '" class="dropdown-item delete-btn deleteBtn">
