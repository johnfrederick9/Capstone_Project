            ...
            <div class="certificate-container">
                <div class="header">
                    ...
                    <div class="header-content">
                        ...
                        <h2 style="margin-bottom: 0; margin-top: 0;"><u>CERTIFICATE OF INDIGENCY</u></h2>
                    </div>
                ...
                <div class="content">
                    <p>This is to <strong>CERTIFY</strong> that <strong style="text-transform: uppercase;">'.$row['indigency_fname'].' and '.$row['indigency_mname'].' </strong>, a resident of and with postal address of Mantalongon, Dalaguete, Cebu Philippines is known as a person of good moral standing in the community.</p>
                    <p>And that persons mentioned above that belongs to indigent families of this barangay.</p>
                    ...
                    <p>This certification is issued upon the request of <strong style="text-transform: uppercase;">'.$row['indigency_fname'].' and '.$row['indigency_mname'].' </strong>, for Scholarship Application of their son/daughter named <strong style="text-transform: uppercase;">'.$row['indigency_cname'].' </strong> as <strong>BIR Requirements</strong>.</p>
