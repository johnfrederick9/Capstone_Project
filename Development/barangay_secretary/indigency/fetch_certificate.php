...
if (isset($_POST['id'])) {
    ...
    // Query to fetch indigency details
            ...
            <div class="certificate-container">
                <div class="header">
                    ...
                    <div class="header-content">
                        ...
                        <h2 style="margin-bottom: 0; margin-top: 0;"><u>BARANGAY CERTIFICATION</u></h2>
                ...
                <div class="content">
                    <p>This is to CERTIFY that <strong style="text-transform: uppercase;">'.$row['indigency_cname'].'</strong>, a resident of Mantalongon, Dalaguete, Cebu, Philippines, is known as a person of good moral standing in the community and has no record inimical to society pursuant to the files available in this office.</p>
                    <p>The person mentioned above is the child of the spouses <strong style="text-transform: uppercase;">'.$row['indigency_fname'].'</strong> and <strong style="text-transform: uppercase;">'.$row['indigency_mname'].'</strong>, who belong to indigent families of this barangay.</p>
                    <p>This is to certify that the total annual family income of their household does not exceed ₱50,000, which is well below the poverty threshold level.</p>
                    <p>This certification is issued upon the request of <strong style="text-transform: uppercase;">'.$row['indigency_cname'].'</strong> for working/scholarship application requirements.</p>
                ...
                <div class="footer">
                    <div class="footer-box">
                        <div class="row">
                            ...
                            <div class="column">
                                <p><strong>₱'.$row['indigency_paid'].'.00</strong></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="column">
                            ...
                            <div class="column">
                                <p><strong>₱'.$row['indigency_dst'].'.00</strong></p>
                            </div>
                        </div>
                    </div>
                    <div>
