...
$indigency_paid = mysqli_real_escape_string($con, $_POST["indigency_paid"]);
$indigency_dst = mysqli_real_escape_string($con, $_POST["indigency_dst"]);

        
$sql = "INSERT INTO `tb_indigency` (`indigency_cname`,`indigency_mname`,`indigency_fname`,`indigency_date`,`indigency_paid`,`indigency_dst`,`isDisplayed`) values ('$indigency_cname', '$indigency_mname', '$indigency_fname', '$indigency_date', '$indigency_paid', '$indigency_dst',1)";
